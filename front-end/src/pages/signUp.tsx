    ...
    >
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">قم بالتسجيل للبدء</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white rounded-lg px-6 py-3 text-gray-700 font-medium hover:bg-gray-50 transition-colors shadow-md hover:shadow-lg"
            style={{ border: "1px solid #dadce0" }} // Google's specific border color
          >
            <svg
              width="18"
              height="18"
            ...
            <span>التسجيل عبر Google</span> {/* Keep "Google" in English */}
          </button>
          ...
          >
            ...
            <span>التسجيل عبر WhatsApp</span>
          </button>
          <button
          ...
          >
            ...
            <span>التسجيل عبر البريد الإلكتروني / رقم الهاتف</span>
          </button>
        </div>
